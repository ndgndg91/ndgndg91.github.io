...
const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    <div className="fixed inset-x-0 top-0 z-50 h-14" suppressHydrationWarning={true}>
        ...
        <div className="flex h-full items-center justify-between gap-8 px-4 sm:px-6">
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <button
              ...
              className="p-2 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white min-w-[40px] flex items-center justify-center"
              aria-label={darkMode ? 'Switch to light mode' : 'Switch to dark mode'}
            >
              {(!isMounted || !darkMode) ? (
                <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" suppressHydrationWarning={true}>
          ...
          <div className="flex items-center lg:hidden gap-2">
            ...
            >
              <svg viewBox="0 0 16 16" fill="currentColor" className="size-5" suppressHydrationWarning={true}>
      ...
      <div className="flex h-14 items-center border-t border-gray-950/5 bg-white px-4 sm:px-6 lg:hidden dark:border-white/10 dark:bg-gray-950" suppressHydrationWarning={true}>
          <button 
          type="button" 
          id="hamburger" 
        ...
        >
          ...
          <svg viewBox="0 0 16 16" fill="currentColor" className="size-4" suppressHydrationWarning={true}>
